...
export const v = {
  ...
  colors: {
    //
    greyTextChat: '#ad2883ff',
    // Use demo colors when DEMO_MODE is enabled
    primary: DEMO_MODE ? DEMO_COLORS.primary : '#a8d141ff',
    warning: '#F1AF20',
    danger: '#DC0F39',
    primaryFn: (lv: number) =>
    ...
    demoPrimary: DEMO_COLORS.primary,
    demoPrimaryLight: DEMO_COLORS.primaryLight,
    demoPrimaryDark: DEMO_COLORS.primaryDark,
  },
  borderTopStyles: {
